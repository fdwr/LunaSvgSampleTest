    ...
    hmonitor_(NULL)
{
    ...
    d2dFactory_.Attach(d2dFactory, true);
    dwriteFactory_.Attach(dwriteFactory, true);
...
RenderTargetDW::RenderTargetDW(IDWriteFactory* dwriteFactory, HWND hwnd, const RECT& rect)
:   hwnd_(hwnd),
    hmonitor_(NULL)
{
