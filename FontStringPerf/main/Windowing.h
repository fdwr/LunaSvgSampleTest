...
#if 0 // redundant
    PositionOptionsRigidHeight      = 4,        // has rigid height (is not changed)
    PositionOptionsRigidWidth       = 8,        // has rigid width (is not changed)
#endif
...
#if 0
    PositionOptionsAlignHMax        = 32768,    // take the maximum of the current width and the new one
#endif
...
#if 0
    PositionOptionsAlignVMax        = 16384,    // take the maximum of the current height and the new one
#endif
