    ...
    case WM_RBUTTONUP:
        {
            ...
            SendMouseNotification(WM_RBUTTONUP);
        }
        break;
    ...
    case WM_LBUTTONDBLCLK:
        {
            ...
            if (message == WM_LBUTTONDOWN)
                SendMouseNotification(NM_CLICK); // WM_LBUTTONDOWN
        }
        break;
    ...
    case WM_MOUSEMOVE:
        {
            ...
            {
                SendMouseNotification(WM_MOUSEMOVE);
            }
            }
        break;
...
void DrawingCanvasControl::SendMouseNotification(uint32_t notificationCode)
{
    NMMOUSE mouse = {};
    mouse.hdr.code = notificationCode;
