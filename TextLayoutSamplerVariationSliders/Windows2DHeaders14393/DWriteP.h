...
struct DWRITE_FONT_AXIS_VALUE_FIXED
{
    DWRITE_FONT_AXIS_TAG axisTag;
    INT32 fixedCoordinate;
};

/// <summary>
/// Private font face reference interface that gives access to axis values of a variable font.
/// </summary>
interface DWRITE_DECLARE_INTERFACE("B1441214-FC0C-4201-A8AF-952C45D7A3B1") IDWritePrivateFontFaceReference : public IDWriteFontFaceReference
{
    virtual UINT32 STDMETHODCALLTYPE GetAxisValueCount() PURE;

    virtual HRESULT STDMETHODCALLTYPE GetAxisValues(_Out_writes_(axisCount) DWRITE_FONT_AXIS_VALUE_FIXED* axisValues, UINT32 axisCount) PURE;
};
...
interface DWRITE_DECLARE_INTERFACE("BD6F5199-F548-493F-A88E-F9419845919B") IDWritePrivateFactory1 : public IUnknown
{
    ...
    STDMETHOD_(void, OverrideSystemRenderingParams)() PURE;

    STDMETHOD_(FLOAT, GetCompatibleGammaOverride)() PURE;
    ...
    STDMETHOD(CreateFontFaceReference)(
        ...
        UINT32 faceIndex,
        _In_reads_opt_(variationAxisCount) DWRITE_FONT_AXIS_VALUE_FIXED const* variationAxisValues, 
        UINT32 variationAxisCount,
        DWRITE_FONT_SIMULATIONS fontSimulations,
        _Out_ IDWriteFontFaceReference** fontFaceReference
        ) PURE;
...
interface DWRITE_DECLARE_INTERFACE("AD247592-E5B0-458E-BA14-3FB9C25FAA0D") IDWritePrivateFactoryForGdi : public IUnknown
{
    ...
    /// <summary>
    /// Returns an IStream with the fixed instance of a variable font.
    /// Accepts the original font bytes as inputs and instances all valid glyphs. 
    /// </summary>
    STDMETHOD(CreateInstancedStream)(
        _In_reads_bytes_(streamSizeInBytes) const void* inputStream, 
        UINT32 streamSizeInBytes,
        UINT16 axisCount,
        _In_reads_(axisCount) DWRITE_FONT_AXIS_TAG* axisTags,
        _In_reads_(axisCount) INT32* fixedPointAxisCoordinates,
        DWRITE_FONT_FACE_TYPE fontFaceType,
        UINT32 faceIndex,
        _COM_Outptr_ IStream** instancedStream
        ) PURE;
};
...
interface DWRITE_DECLARE_INTERFACE("F5ADA939-A4E1-4C50-921B-0E448CB7A8D4") IDWritePrivateFontFace : public IDWriteFontFace4
{
    ...
    /// <summary>
    /// Returns true if the font face requires instancing i.e. if it is a variable font and
    /// the instance axis coordinates are not all default.
    /// </summary>
    STDMETHOD_(BOOL, IsInstancingRequired)() PURE;

    /// <summary>
    /// Returns axis coordinate count of this fontface instance.
    /// </summary>
    STDMETHOD_(UINT32, GetAxisCount)() PURE;

    /// <summary>
    /// Returns instance axis coordinates of this fontface instance.
    /// </summary>
    STDMETHOD(GetInstanceAxisCoordinates)(_Out_ float* instanceCoordinates, UINT32 count) PURE;
