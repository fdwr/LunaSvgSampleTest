				...
				while (st.hasMoreTokens()) {
					...
					case DIV_SYSTEM:
						if (sTok.startsWith("ACT="))
							m_Enabled = Integer.valueOf(sTok.substring(4))
									.intValue() != 0;
						break;
					case DIV_NOISE:
						if (sTok.startsWith("ACT="))
							m_NoiseActive = Integer.valueOf(sTok.substring(4))
									.intValue() != 0;
					...
					case DIV_BHOLE:
						if (sTok.startsWith("ACT="))
							m_BHoleActive = Integer.valueOf(sTok.substring(4))
									.intValue() != 0;
					...
					case DIV_SNOVA:
						if (sTok.startsWith("ACT="))
							m_SNovaActive = Integer.valueOf(sTok.substring(4))
									.intValue() != 0;
						else if (sTok.startsWith("X=")) {
