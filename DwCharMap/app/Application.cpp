...
:   UiContainer(nullptr),
    renderTargetType_(RenderTargetTypeDW)
{
...
void MainWindow::InitializeControls()
{
    ...
    ribbonChunk = new RibbonChunk(ribbon_, L"Font");
        ...
        buttonGroup = new ButtonGroup(ribbonChunk, 0, true);
            button = new FlatButton(buttonGroup, L"[font family]", nullptr, ControlIdFont, Button::BehaviorActiveOnPress);
            button->SetOwner(this, this);
            button->SetPosition(MakePosition(0,0,90,0));
            button->SetStyle(StyleFlagRigidWidth);

        buttonGroup = new ButtonGroup(ribbonChunk, 0, true);
            button = new FlatButton(buttonGroup, L"[font size]", nullptr, ControlIdFontSize, Button::BehaviorActiveOnPress);
            button->SetOwner(this, this);
        ...
        buttonGroup->SetStyle(StyleFlagNewLine);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdFormatBold), ControlIdFormatBold, Button::BehaviorToggle);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdFormatItalic), ControlIdFormatItalic, Button::BehaviorToggle);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdFormatUnderline), ControlIdFormatUnderline, Button::BehaviorToggle);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdFormatStrikethrough), ControlIdFormatStrikethrough, Button::BehaviorToggle);

        buttonGroup = new ButtonGroup(ribbonChunk, 0, true);
            button = new FlatButton(buttonGroup, L"Style", nullptr, ControlIdTypographicFeature, Button::BehaviorActiveOnPress);
            button->SetOwner(this, this);
    ...
    ribbonChunk = new RibbonChunk(ribbon_, L"Paragraph");
        ...
        buttonGroup->SetOwner(this, this);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdAlignLeft),     ControlIdAlignLeft, Button::BehaviorSwitch);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdAlignHCenter),  ControlIdAlignHCenter, Button::BehaviorSwitch);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdAlignRight),    ControlIdAlignRight, Button::BehaviorSwitch);
            buttonGroup->SetActiveMember(IsReadingRtl() ? ControlIdAlignRight : ControlIdAlignLeft);

        buttonGroup = new ButtonGroup(ribbonChunk, 0, true);
        buttonGroup->SetStyle(StyleFlagReadingLtr|StyleFlagReadingExplicit, StyleFlagReadingRtl);
        buttonGroup->SetOwner(this, this);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdLtr),    ControlIdLtr, Button::BehaviorSwitch);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdRtl),    ControlIdRtl, Button::BehaviorSwitch);
            buttonGroup->SetActiveMember(IsReadingRtl() ? ControlIdRtl : ControlIdLtr);

        buttonGroup = new ButtonGroup(ribbonChunk, 0, true);
        buttonGroup->SetStyle(StyleFlagNewLine);
        buttonGroup->SetOwner(this, this);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdAlignTop),     ControlIdAlignTop, Button::BehaviorSwitch);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdAlignVCenter), ControlIdAlignVCenter, Button::BehaviorSwitch);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdAlignBottom),  ControlIdAlignBottom, Button::BehaviorSwitch);
            buttonGroup->SetActiveMember(ControlIdAlignTop);

        buttonGroup = new ButtonGroup(ribbonChunk, 0, true);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdWrap),  ControlIdWrap, Button::BehaviorToggle);
            new FlatButton(buttonGroup, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdTrim),  ControlIdTrim, Button::BehaviorToggle);
    ...
    ribbonChunk = new RibbonChunk(ribbon_, L"View");
        ...
        buttonGroup = new ButtonGroup(ribbonChunk, 0, true);
        buttonGroup->SetOwner(this, this);
            button = new FlatButton(buttonGroup, L"D2D DrawGlyphRun",nullptr,    ControlIdRenderD2D, Button::BehaviorSwitch);
            //button->SetStyle(StyleFlagNewLine| (d2dFactory_ == nullptr ? StyleFlagDisabled : StyleFlagNone));
            button = new FlatButton(buttonGroup, L"DW DrawGlyphRun", nullptr,    ControlIdRenderDW,  Button::BehaviorSwitch);
            button->SetStyle(StyleFlagNewLine);
            button = new FlatButton(buttonGroup, L"GDI ExtTextOut",  nullptr,    ControlIdRenderGDI, Button::BehaviorSwitch);
            button->SetStyle(StyleFlagNewLine);
            new Label(buttonGroup, L"/");
            new FlatButton(         buttonGroup, L"GDI+",           nullptr,    ControlIdRenderGDIPlus, Button::BehaviorSwitch);
    ...
    ribbonChunk = new RibbonChunk(ribbon_, L"Samples");
        ...
        buttonGroup->SetOwner(this, this);
            new FlatButton(buttonGroup, L"Sample layout ˃", nullptr, ControlIdLayoutSample, Button::BehaviorActiveOnPress);
            new FlatButton(buttonGroup, L"Profile… (F2)", nullptr, ControlIdShowProfileDialog);
    ...
    statusBar_.Set(new StatusBar(this, 3));
        ...
        caretPositionLabel_.Set(new FlatButton(statusBar_, L"Caret: 0x0", nullptr, ControlIdGoto));
        caretPositionLabel_->SetStyle(UiControl::StyleFlagDisabledMouseFocus);

        new StatusBar::Divider(statusBar_);
        new FlatButton(statusBar_, L"English \x202A(en-us)\x202C", nullptr, ControlIdLocale, Button::BehaviorActiveOnPress);
        new StatusBar::Divider(statusBar_);

        editorZoomLabel_.Set(new FlatButton(statusBar_, L"100%", nullptr, ControlIdZoom, Button::BehaviorActiveOnPress));
        new FlatButton(statusBar_, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdZoomIn), ControlIdZoomIn);
        new FlatButton(statusBar_, nullptr, new InlineImage(toolbarImagesSmall_, ControlIdZoomOut), ControlIdZoomOut);
        new FlatButton(statusBar_, L" ↻", nullptr, ControlIdRotateRectus);
        new FlatButton(statusBar_, L" ↺", nullptr, ControlIdRotateSinister);
        new FlatButton(statusBar_, L" ↔", nullptr, ControlIdFlipHorizontal);
        new FlatButton(statusBar_, L" ↕", nullptr, ControlIdFlipVertical);
        new FlatButton(statusBar_, L" ⊡ ", nullptr, ControlIdResetView);
...
void MainWindow::OwnAllButtons(UiControl* container)
{
    ...
    container->GetChild(nullptr, &childrenTotal);

    for (size_t childIndex = 0; childIndex < childrenTotal; ++childIndex)
    {
        UiControlRefPtr child;
        if (container->GetChild(childIndex, child) && child != nullptr)
        {
            ...
            if (button != nullptr)
            {
                ...
                if (!button->GetOwner(nullptr,nullptr))
                    button->SetOwner(this, this);
...
{
    MainWindow* window = reinterpret_cast<MainWindow*>(static_cast<LONG_PTR>(GetWindowLongPtr(hwnd, GWLP_USERDATA)));
...
bool MainWindow::CaretMoved(TextEditor* source, int id)
{
    ...
    caretPositionLabel_->SetLabel(buffer, nullptr);
...
bool MainWindow::ViewChanged(TextEditor* source, int id)
{
    ...
    editorZoomLabel_->SetLabel(buffer, nullptr);
#endif
    return true;
}
    ...
    case ControlIdTypographicFeature:
        {
            ...
            if (typoFeature != nullptr && typoFeature->GetFontFeatureCount() == 1)
            {
                DWRITE_FONT_FEATURE fontFeature;
                //typoFeature->GetFontFeature(0 , &fontFeature);
...
void MainWindow::GetLayoutSampleIntroduction(IDWriteTextEditLayout& textLayout)
{
    ...
    textLayout.InsertTextAt(0, sampleText, ARRAY_SIZE(sampleText)-1, nullptr);
...
void MainWindow::GetLayoutSampleLongString(IDWriteTextEditLayout& textLayout)
{
    ...
    textLayout.InsertTextAt(0, sampleText, sampleTextSize, nullptr);
    textLayout.SetFontFamilyName(L"Arial", MakeDWriteTextRange(0));
    textLayout.SetFontSize(16, MakeDWriteTextRange(0));
}
