...
csym PgfxCurrentFlags,	dd .redraw|.cursorSet|.cursorMove ;.FlagsUseMMX|.FlagsSlowPc
...
%if PlainUseMMX
	...
	or dword [PgfxCurrentFlags],PgfxCurrentFlags.hasMMX|PgfxCurrentFlags.useMMX
.NoMMX:
	pop ebx
%endif
...
.Raw: ; dest and source ptrs have been precalculated, top/left ignored
	...
	;mov edx,[.destWidth]
%if PlainUseMMX
	test dword [PgfxCurrentFlags],PgfxCurrentFlags.useMMX
	jnz .MMX
%endif
...
;	jnz .MMX
;%endif
	test dword [PgfxCurrentFlags],PgfxCurrentFlags.mulInit
	jnz .MulInit
	call PgfxMulTblInit
.MulInit:
...
.EndMul:
	...
	pop esi
	pop ebx
	or dword [PgfxCurrentFlags],PgfxCurrentFlags.mulInit
	ret
