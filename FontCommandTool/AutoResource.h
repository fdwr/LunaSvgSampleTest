...
template <
    ...
    ResourceReleaserSignature ResourceReleaser  // address of function to release object
>
struct KernelHandleResourceTypePolicy : public DefaultResourceTypePolicy<ResourceType>
{
    inline static bool IsNull(ResourceType resource) throw()
    {
        return (resource == 0 || resource == INVALID_HANDLE_VALUE);
    }
...
typedef AutoResource<HANDLE,  KernelHandleResourceTypePolicy<HANDLE,  BOOL (WINAPI*)(HANDLE),  &CloseHandle> >             FileHandle;
typedef AutoResource<HANDLE,  KernelHandleResourceTypePolicy<HANDLE,  BOOL (WINAPI*)(HANDLE),  &CloseHandle> >             MemorySectionResource;
...
template<typename ResourceType> using ComPtr = AutoResource<ResourceType*, ComResourceTypePolicy, IUnknown*>;
...
template<typename ResourceType>
class AutoPointer : public AutoResource<ResourceType*, OwnedPointerResourceTypePolicy<ResourceType*>, ResourceType* >
{
public:
    typedef AutoResource<ResourceType*, OwnedPointerResourceTypePolicy<ResourceType*>, ResourceType* > Base;
    ...
    inline Self(Self&& other) : Base(static_cast<Base&&>(resource)) {}
    inline Self(Self const& other) {} // todo: move this into private!
