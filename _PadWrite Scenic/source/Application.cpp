...
ComPtr<IUIFramework> g_pScenicFramework;
    ...
    )
{
    ...
    case CommandIdFont:
        UpdateCaretToUi(pCommandExecutionProperties);
        break;
...
void MainWindow::UpdateUiToCaret(bool redrawTextEditor)
{
...
void MainWindow::UpdateCaretToUi(IUISimplePropertySet* pCommandExecutionProperties)
{
